...
function Signup() {
  ...
  return (
    <div className="flex flex-col lg:flex-row lg:h-screen min-h-screen bg-gradient-to-b from-blue-900 to-blue-600  justify-between text-white">
      ...
      <div className="lg:w-full">
        ...
        <div className="bg-white text-black flex flex-col lg:min-h-screen lg:w-full lg:justify-center lg:items-center">
          ...
          <div className="lg:w-full ">
            <div className="mt-8 mx-6 border-b border-gray-600 lg:mx-64  ">
            ...
            <div className="mt-8 mx-6 border-b lg:mx-64 border-gray-600">
              <div className="flex w-full">
                <div>
                  <svg
                    className="w-6"
            ...
            <div className="mb-1 mt-8 mx-6 border-b lg:mx-64 border-gray-600">
              <div className="flex w-full ">
                <div>
            ...
            <div className="mx-6 mt-5  lg:mx-64">
              <button
            ...
            <div className="mx-6 mb-10  lg:mx-64">
              <Link to="/signin">
